export const advantageItems = [
  {
    title: '统一平台架构',
    desc: '智能体、机器人、知识库、工作流不是零散拼装，而是统一在一套架构里协同工作。',
  ...
  {
    title: '内置 MCP 工具接入',
    desc: '连接魔搭等外部工具和服务，让智能体不只回答问题，还能真正执行操作。',
  ...
  {
    title: '多媒体能力',
    desc: '除文字对话外，可扩展文件解析、图片生成、视频生成等多媒体处理能力。',
  ...
  {
    title: '多端 API 对接',
    desc: '除 AI 能力外，支持对接移动端、PC 端、H5 和传统 REST API。',
  ...
  },
  {
    ...
    desc: '天然拥有模块化中后台能力，可继续扩展业务模块、后台页面和资源接口。',
